/*
 * $Id: WebColors.java 5914 2013-07-28 14:18:11Z blowagie $
 *
...
public class WebColors extends HashMap<String, int[]> {
    ...
    public static BaseColor getRGBColor(String name)
        ...
        if (!NAMES.containsKey(name))
            throw new IllegalArgumentException(MessageLocalization.getComposedMessage("color.not.found", (Object) new String[] { name }));
        c = NAMES.get(name);
        return new BaseColor(c[0], c[1], c[2], c[3]);
    }
}
